(function(){
    angular
        .module('proyecto')
        .controller('ServiciopublicoController', ServiciopublicoController);

    function ServiciopublicoController($http, $rootScope) {
        var vm = this;

        $rootScope.tituloMenu = 'Administración';
      	$rootScope.subtituloMenu = 'Servicio Publico';
      	vm.mensaje = {};
      	vm.objeto = {};
      	vm.id = '';
      	vm.nombre = '';
