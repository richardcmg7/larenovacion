(function(){
    angular
        .module('proyecto')
        .controller('GruposanguineoController', GruposanguineoController);

    function GruposanguineoController($http, $rootScope) {
        var vm = this;

        $rootScope.tituloMenu = 'Administración';
      	$rootScope.subtituloMenu = 'Grupo Sanguineo y Factor RH';
      	vm.mensaje = {};
      	vm.objeto = {};
      	vm.id = '';
      	vm.nombre = '';
