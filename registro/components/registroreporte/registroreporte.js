(function(){
    angular
        .module('proyecto')
        .controller('RegistroreporteController', RegistroreporteController);

    function RegistroreporteController($http, $rootScope) {
        var vm = this;

        $rootScope.tituloMenu = 'Registro';
        $rootScope.subtituloMenu = 'Reporte';
        vm.mensaje = {};
        vm.objeto = {};
        vm.filtro = {
            "documento": '',
