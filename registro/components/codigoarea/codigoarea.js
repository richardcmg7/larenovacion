(function(){
    angular
        .module('proyecto')
        .controller('CodigoareaController', CodigoareaController);

    function CodigoareaController($http, $rootScope) {
        var vm = this;

        $rootScope.tituloMenu = 'Administración';
      	$rootScope.subtituloMenu = 'Codigo Area';
      	vm.mensaje = {};
      	vm.objeto = {};
      	vm.id = '';
      	vm.nombre = '';
