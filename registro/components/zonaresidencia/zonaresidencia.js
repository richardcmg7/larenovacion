(function(){
    angular
        .module('proyecto')
        .controller('ZonaresidenciaController', ZonaresidenciaController);

    function ZonaresidenciaController($http, $rootScope) {
        var vm = this;

        $rootScope.tituloMenu = 'Administración';
      	$rootScope.subtituloMenu = 'Zona de Residencia';
      	vm.mensaje = {};
      	vm.objeto = {};
      	vm.id = '';
      	vm.nombre = '';
